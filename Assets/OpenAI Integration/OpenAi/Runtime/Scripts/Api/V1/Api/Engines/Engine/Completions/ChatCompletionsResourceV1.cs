...
namespace OpenAi.Api.V1
{
    ...
    public class ChatCompletionsResourceV1 : AApiResource<OpenAiApiV1>
    {
        ...
        /// <param name="request"></param>
        /// <returns>Asynchronously returns the completion result.  Look in its <see cref="CompletionResult.Choices"/> property for the completions.</returns>
        public async Task CreateCompletionAsync_EventStream(ChatCompletionRequestV1 request, Action<ApiResult<ChatCompletionV1>> onRequestStatus, Action<int, ChatCompletionV1> onPartialResult, Action onCompletion = null)
        {
        ...
        /// <param name="request"></param>
        /// <returns>Asynchronously returns the completion result.  Look in its <see cref="CompletionResult.Choices"/> property for the completions.</returns>
        public Coroutine CreateCompletionCoroutine_EventStream(MonoBehaviour mono, ChatCompletionRequestV1 request, Action<ApiResult<ChatCompletionV1>> onRequestStatus, Action<int, ChatCompletionV1> onPartialResult, Action onCompletion = null)
        {
